...
import { navigate, setAccounts, setSummaryData, setTransactions } from "./actionCreators";
...
export class ResourceManager {
    ...
    transactionTable(accountId: string | null = null) {
        ...
        this.authClient?.post('/transaction/table', body).then((response) => {
            ...
            this.dispatch(setTransactions(normalizedTransactions));
        })
    }
