...
class TransactionClient:
    ...
    def get_all_transactions(self) -> List[Transaction]:
        ...
        try:
            response = self.dynamodb.scan(TableName=self.transaction_table_name)
            data = response["Items"]
    ...
    def get_recent_transactions(self):
        ...
        try:
            ...
            transactions = [
                Transaction.from_dynamodb(transaction) for transaction in data
            ]
    ...
    def get_transactions(self, transaction_ids: List[str]):
        self.logger.info(
            "Attempting to fetch transactions - {}".format(transaction_ids)
        )
